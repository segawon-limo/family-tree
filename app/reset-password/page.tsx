        ...
        <div style={{
          ...
          {state === 'invalid' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 13, opacity: 0.6 }}>
                Hubungi admin keluarga untuk minta link reset baru.
              </p>
            </div>
          )}
          ...
          {state === 'valid' && (
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <p style={{ fontSize: 14, margin: 0, opacity: 0.8 }}>
                Halo, <strong>{nama}</strong>! Masukkan password baru untuk akunmu.
              </p>
          ...
          {state === 'done' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 14, fontWeight: 600 }}>Password berhasil direset!</p>
              <p style={{ fontSize: 13, opacity: 0.6 }}>
